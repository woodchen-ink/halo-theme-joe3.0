/* PrismJS 1.25.0
// modified: selector、label
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+cpp+csharp+docker+git+go+graphql+http+java+json+kotlin+less+lua+makefile+nginx+php+powershell+python+jsx+tsx+regex+ruby+rust+sass+scss+sql+swift+typescript+yaml&plugins=line-numbers+show-language+toolbar+copy-to-clipboard */
	...
	var _ = {
		...
		highlightAllUnder: function (container, async, callback) {
			var env = {
				callback: callback,
				container: container,
				selector: 'pre code, code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'
			};
        ...
        if(RegExp.$2) {
          ...
          element.setAttribute('class', RegExp.$1);
        }
...
(function () {
	...
	var hook = Prism.plugins.toolbar.hook = function (env) {
      ...
      element.setAttribute("data-rel", element.textContent);
      element.innerHTML = "";
